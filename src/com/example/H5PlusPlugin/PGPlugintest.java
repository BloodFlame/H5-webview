...
import com.hyphenate.easeuisimpledemo.ui.LoginActivity;
import com.hyphenate.easeuisimpledemo.ui.MainActivity;
...
{   
    ...
    public void PluginTestFunction(IWebview pWebview, JSONArray array)
    {
        ...
        EaseUI.getInstance().init(pWebview.getContext(), null);
        pWebview.getContext().startActivity(new Intent(pWebview.getContext(), MainActivity.class));
        JSUtil.execCallback(pWebview, CallBackID, "启动成功", JSUtil.OK, false);
